...
describe('Home', () => {
  it('should render create account modal when clicking on cta create account button', () => {
    cy.visit(APP_URL)
  ...
  it('should render create account modal when clicking on header create account button', () => {
    cy.visit(APP_URL)
  ...
  it('should render login modal when clicking on header login button', () => {
    cy.visit(APP_URL)
